            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('subcategories.index') }}" class="btn btn-outline-warning btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('subcategories.update', $subcategory->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" rows="4">{{ old('description', $subcategory->description) }}</textarea>
