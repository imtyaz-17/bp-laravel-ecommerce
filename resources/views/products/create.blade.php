                        ...
                        <form action="{{ route('products.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input id="old_price" type="number" step="0.01" min="0" class="form-control @error('old_price') is-invalid @enderror" name="old_price" value="{{ old('old_price') }}">
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <span class="input-group-text">৳</span>
                                        <input id="new_price" type="number" step="0.01" min="0" class="form-control @error('new_price') is-invalid @enderror" name="new_price" value="{{ old('new_price') }}" required>
                                    </div>
