                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" rows="4">{{ old('description', $category->description) }}</textarea>
